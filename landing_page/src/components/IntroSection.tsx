export default function IntroSection() {
    return (
        <section className="text-center py-4 md:py-0" style={{ lineHeight: 2.2 }}>
            <p className="font-bold text-[15px] md:text-[22px] lg:text-[26px] mb-6 md:mb-10">
                合格できる学校ではなく、続けられる学校を。
            </p>
            <div className="text-[14px] md:text-[17px] lg:text-[19px] text-text-sub space-y-4 md:space-y-6">
                <p>
